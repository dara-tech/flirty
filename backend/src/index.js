...
const KEEP_ALIVE_INTERVAL =
  parseInt(process.env.KEEP_ALIVE_INTERVAL) || 14 * 60 * 1000; // 14 minutes in milliseconds
...
app.get("/api/health", (req, res) => {
  const rateLimiterHealth = rateLimiterHealthCheck();
...
// Metrics endpoint (protected, only in development)
