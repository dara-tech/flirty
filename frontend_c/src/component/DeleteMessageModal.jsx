...
const DeleteMessageModal = ({ isOpen, onClose, message, onDelete, isDeleting }) => {
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-base-100 rounded-2xl w-full max-w-md shadow-2xl border border-base-200/50 overflow-hidden">
        ...
        <div className="px-4 sm:px-6 py-4 border-b border-base-200/50 bg-base-100 flex items-center justify-between">
          <h2 className="text-lg sm:text-xl font-semibold text-base-content">Delete Message</h2>
          <button
            onClick={onClose}
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-base-content/60 mt-0.5">
                    Remove this message only from your view
                  </div>
                </div>
                {deleteType === "forMe" && (
                  <div className="size-5 rounded-full bg-primary border-2 border-primary flex items-center justify-center">
